...
export default function News() {
  useEffect(() => {
    const widthCard = $('.card-news')[0].offsetWidth + 24
    ...
    <div className="news container">
      <div className="title-h2">
        ...
        <div className='group-view-btn'>
          <button type="button" className='btn-view btn-view-all'><a href="/">VIEW ALL</a></button>
      ...
      <div className="card-list" id="scroll-bar-news">
